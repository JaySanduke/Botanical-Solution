                    ...
                    <div className="col-lg-6">
                        <div className="plant-section">
                            ...
                            <div className="controls">
                                {/* three text fields */}
                                <div className="mb-3">
                                    <label htmlFor="exampleFormControlInput1" className="form-label">Temperature</label>
                                    <input type="number" className="form-control" id="exampleFormControlInput1" value={Temperature} onChange={handleTemperatureChange} placeholder="Eg: 34 (in degrees)" />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="exampleFormControlInput1" className="form-label">Precipitation</label>
                                    <input type="number" className="form-control" id="exampleFormControlInput1" value={Precipitation} onChange={handlePrecipitationChange} placeholder="Eg: 84" />
                                </div>
                                <div className="mb-3">
                                    <label htmlFor="exampleFormControlInput1" className="form-label">Elevation</label>
                                    <input type="number" className="form-control" id="exampleFormControlInput1" value={Elevation} onChange={handleElevationChange} placeholder="Eg: 240" />
                                </div>
                                <div className="d-flex justify-content-end align-items-center py-4">
